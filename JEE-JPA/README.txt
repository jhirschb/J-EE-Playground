...
a persistence unit "jee-jpaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jee-jpa\pom.xml":
...
artifact ("jee-jpa.war") is already built. You can build
